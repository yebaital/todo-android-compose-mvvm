...
import net.virtualcoder.todo.data.repositories.DataStoreRepository
...
class SharedViewModel @Inject constructor(
    ...
    private fun addTask() {
        ...
        //when adding task from search results screen return to all tasks instead of searched tasks
